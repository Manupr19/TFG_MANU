...
__all__ = [
    'SPWF_SRENGINE', 'DISPID_SpeechPhraseElement', 'SPRST_NUM_STATES',
    'DISPID_SRRDiscardResultInfo', 'SRAInterpreter',
    'SPEI_TTS_PRIVATE', 'SECFIgnoreCase', 'eLEXTYPE_PRIVATE8',
    'SPCS_DISABLED', 'eLEXTYPE_USER', 'SVP_16',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSLastBookmark',
    'SAFT44kHz8BitMono', 'DISPID_SRGetPropertyNumber', 'SSFMCreate',
    'DISPID_SPRsCount', 'DISPID_SGRsDynamic', 'DISPID_SpeechAudio',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRPhraseInfo',
    'SPCT_COMMAND', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SREStreamStart', 'DISPID_SRCState',
    'SpeechEmulationCompareFlags', 'DISPID_SRCEAudioLevel',
    'SPBO_PAUSE', 'SpeechCategoryRecoProfiles',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRERecoOtherContext',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_PHRASE_START',
    'DISPID_SGRsCount', 'ISpStream', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRRSetTextFeedback', 'SpeechCategoryPhoneConverters',
    'SpFileStream', 'SVP_10', 'SVP_2', 'SP_VISEME_1', 'SP_VISEME_11',
    'SPPROPERTYINFO', 'DISPID_SpeechFileStream', 'SAFT12kHz8BitMono',
    'DISPID_SpeechAudioBufferInfo', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRCPause', 'DISPID_SGRAddResource', 'DISPID_SBSSeek',
    'ISpStreamFormat', 'DISPID_SVSLastResult', 'DISPID_SVDisplayUI',
    'ISpeechPhraseInfo', 'SPPS_RESERVED2', 'SSSPTRelativeToEnd',
    'DISPID_SRRRecoContext', 'SpeechEngineProperties',
    'DISPID_SWFEExtraData', 'SRESoundStart', 'SpeechMicTraining',
    'DISPID_SPIGrammarId', 'SP_VISEME_15', 'SPSInterjection',
    'DISPID_SVESentenceBoundary', 'SRARoot', 'ISpeechPhraseElements',
    'eLEXTYPE_MORPHOLOGY', 'SPSMF_UPS', 'SVSFNLPMask',
    ...
    'SPAR_Low', 'DISPID_SPEDisplayAttributes', 'eLEXTYPE_APP',
    'DISPID_SRIsUISupported', 'ISpeechPhraseAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPEI_SOUND_START',
    'SpeechGrammarTagWildcard', 'SPRECOCONTEXTSTATUS', 'SVF_Emphasis',
    'SSFMOpenForRead', 'DISPID_SBSWrite', 'DISPID_SRCVoicePurgeEvent',
    'SpeechPropertyHighConfidenceThreshold', 'SPAUDIOSTATE',
    'SPWT_DISPLAY', 'SPRULE', 'DISPID_SPIStartTime',
    'SVEEndInputStream', 'eLEXTYPE_PRIVATE12',
    'DISPID_SVGetAudioOutputs', 'DISPID_SDKSetStringValue',
    'SECFNoSpecialChars', 'DISPID_SLRemovePronunciation', 'SpStream',
    'SPVISEMES', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechDisplayAttributes', 'SREAllEvents', 'SPSHORTCUTPAIR',
    'DISPID_SPRNumberOfElements', 'SINoSignal', 'eLEXTYPE_PRIVATE4',
    'DISPID_SVVoice', 'Speech_StreamPos_Asap',
    'DISPID_SVSInputWordLength', 'SBOPause', 'SAFT11kHz8BitStereo',
    ...
    'SP_VISEME_5', 'SGDisplay', 'ISpeechWaveFormatEx',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'SPSHORTCUTPAIRLIST', 'SpeechTokenShellFolder',
    'DISPID_SpeechRecognizerStatus', 'SREPrivate',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGCommit', 'SPEI_RESERVED1',
    'SpUnCompressedLexicon', 'SAFTADPCM_8kHzStereo',
    'SECLowConfidence', 'SAFTADPCM_22kHzStereo', 'SVSFPersistXML',
    'STSF_AppData', 'DISPID_SVEEnginePrivate',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDKLDefaultLocation',
    'UINT_PTR', 'SPXMLRESULTOPTIONS', 'SRERecognition', 'SREBookmark',
    ...
    'DISPID_SVSLastBookmarkId', 'SSSPTRelativeToCurrentPosition',
    'SpeechPropertyAdaptationOn', 'SpeechRecognizerState',
    'DISPID_SPRulesItem', 'STSF_FlagCreate', 'SVP_19',
    'ISpRecognizer3', 'DISPID_SRCERecognitionForOtherContext',
    'ISpeechBaseStream', 'SpeechAddRemoveWord',
    'DISPID_SASCurrentDevicePosition', 'ISpeechMMSysAudio',
    'DISPID_SPRuleChildren', 'DISPID_SRCEEnginePrivate',
    'SPCATEGORYTYPE', 'DISPID_SRCCreateResultFromMemory',
    'SpeechAllElements', 'ISpeechFileStream', 'SPEI_RESERVED6',
    'SREInterference', 'SVEStartInputStream', 'SWTAdded',
    'SPRECORESULTTIMES', 'ISpPhoneConverter', 'ISpeechRecoResult2',
    'ISpeechPhraseProperties', 'DISPID_SOTSetId',
    'SpeechAudioFormatType', 'SpeechWordType',
    'ISpeechLexiconPronunciation', 'DISPID_SVRate',
    'SDA_One_Trailing_Space', 'SWPKnownWordPronounceable',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPIProperties', 'SPPS_Noun',
    'DISPID_SPRuleFirstElement', 'DISPID_SRSAudioStatus',
    'SPSHT_NotOverriden', '_RemotableHandle', 'SVP_17', 'SRSActive',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCESoundEnd',
    'SREPropertyNumChange', 'ISpeechLexiconPronunciations',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SAVolume',
    'DISPID_SDKEnumKeys', 'DISPID_SASNonBlockingIO',
    'SGDSActiveUserDelimited', 'SAFT24kHz16BitStereo',
    'DISPID_SVEStreamEnd', 'SVP_5', 'SPEI_INTERFERENCE',
    'SpeechCategoryAudioOut', 'DISPID_SWFEBlockAlign',
    'DISPID_SRAudioInput', 'ISpNotifyTranslator', 'SLTApp',
    'SLOStatic', 'SGDSInactive', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRGSetTextSelection', 'DISPIDSPTSI_ActiveLength',
    'SpeechCategoryAudioIn', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechPhraseProperties', 'ISpeechLexiconWord',
    'DISPID_SOTCreateInstance', 'SVEPhoneme', 'SGDSActive', 'SpVoice',
    'DISPID_SVEventInterests', 'SPSERIALIZEDPHRASE',
    'SPWORDPRONOUNCEABLE', 'SPPS_Verb',
    'DISPID_SpeechGrammarRuleState', 'SPRULESTATE',
    'DISPID_SRGCmdLoadFromFile', 'eWORDTYPE_ADDED',
    'DISPID_SPCIdToPhone', 'SRCS_Disabled', 'SDTPronunciation',
    'DISPID_SVVolume', 'SpMemoryStream', 'ISpeechPhraseRules',
    'DISPID_SCSBaseStream', 'DISPID_SRAudioInputStream',
    'SpStreamFormatConverter', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCSetAdaptationData', 'SpeechStreamSeekPositionType',
    'SPAR_High', 'SAFT8kHz16BitMono', 'SAFTCCITT_ALaw_8kHzMono',
    'SPPS_Modifier', 'SpeechTokenKeyAttributes', 'DISPID_SRCBookmark',
    'ISpeechMemoryStream', 'SpeechRecoContextState',
    'SVESentenceBoundary', 'SpeechSpecialTransitionType',
    'DISPID_SDKCreateKey', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPAsItem', 'DISPID_SpeechAudioStatus',
    'ISpeechAudioStatus', 'SWTDeleted', 'SRADynamic',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SLPPartOfSpeech', 'SVP_1',
    'SDTAll', 'ISpeechRecoGrammar', 'DISPID_SpeechPhraseRule',
    'SPEI_RESERVED2', 'DISPID_SRRTLength',
    'SpTextSelectionInformation', 'SpeechGrammarTagDictation',
    'SPGS_EXCLUSIVE', 'SRADefaultToActive', 'DISPID_SPIGetText',
    'SRSInactiveWithPurge', 'SpeechCategoryAppLexicons',
    'DISPID_SLWType', 'SAFT44kHz16BitMono',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SGRSTWeight', 'SVP_9', 'ISpRecognizer2',
    'ISpPhoneticAlphabetSelection', 'SPBINARYGRAMMAR', 'SP_VISEME_18',
    'SAFT22kHz16BitMono', 'SDTAudio', 'DISPID_SRState',
    'DISPID_SPRDisplayAttributes', 'SpeechVoiceSpeakFlags',
    'SVSFIsFilename', 'SDTReplacement', 'DISPID_SOTsCount',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT48kHz8BitMono',
    'DISPID_SPIEngineId', 'DISPID_SASState', 'SPPHRASEPROPERTY',
    'SFTInput', 'DISPID_SGRsCommitAndSave', 'DISPID_SVGetProfiles',
    'tagSTATSTG', 'SVSFIsXML', 'Speech_StreamPos_RealTime',
    'DISPID_SLPsItem', 'SPAUDIOOPTIONS', 'SPAO_RETAIN_AUDIO',
    'ISpEventSource', 'SP_VISEME_16', 'SVP_21', 'ISpPhraseAlt',
    'DISPID_SpeechLexiconWord', 'DISPID_SVResume',
    'DISPID_SPEPronunciation', 'DISPID_SGRInitialState',
    'DISPID_SPRText', 'DISPID_SpeechBaseStream',
    'DISPID_SPRuleParent', 'DISPID_SRCESoundStart',
    'SPEI_RECOGNITION', 'SDTDisplayText', 'DISPID_SVEViseme',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVEAudioLevel',
    'SSTTDictation', '_SPAUDIOSTATE', 'SAFT44kHz16BitStereo',
    'SP_VISEME_21', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT24kHz8BitMono',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGState', 'SPFM_NUM_MODES',
    'SRAExport', 'DISPID_SRCCmdMaxAlternates', 'SECFEmulateResult',
    'SGRSTTEpsilon', 'SGRSTTRule', 'eLEXTYPE_RESERVED10',
    'SPEI_UNDEFINED', 'DISPID_SPPFirstElement', 'eLEXTYPE_RESERVED6',
    'SPFILEMODE', 'SDA_No_Trailing_Space', 'SAFTGSM610_11kHzMono',
    'SVSFVoiceMask', 'DISPID_SPILanguageId',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechRecoContext',
    'SREAdaptation', 'SECFIgnoreKanaType', 'SpInprocRecognizer',
    'SPINTERFERENCE', 'DISPID_SPRs_NewEnum', 'DISPID_SLPLangId',
    'DISPIDSPTSI', 'SpeechPartOfSpeech', 'DISPID_SRProfile',
    'SpeechFormatType', 'ISpeechLexicon', 'SDKLCurrentUser',
    'SITooLoud', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpObjectToken',
    'eLEXTYPE_RESERVED8', 'SpeechVisemeType', 'SPLO_DYNAMIC',
    'ISpeechPhraseProperty', 'eLEXTYPE_PRIVATE10', 'SPRS_INACTIVE',
    'SPEI_START_SR_STREAM', 'SAFTCCITT_ALaw_11kHzStereo', 'SPXRO_SML',
    'DISPID_SRRGetXMLResult', 'ISpRecoCategory',
    'DISPID_SLWPronunciations', 'SVEViseme', 'DISPID_SPISaveToMemory',
    'ISpeechPhoneConverter', 'ISpRecoGrammar', 'SPPS_NotOverriden',
    'SPPHRASE', 'SVP_0', 'DISPID_SRRSpeakAudio', 'eLEXTYPE_PRIVATE11',
    'SRATopLevel', 'DISPID_SpeechVoiceStatus', 'SpeechLoadOption',
    'DISPID_SPEs_NewEnum', 'SVEBookmark', 'SAFT16kHz16BitMono',
    'eLEXTYPE_PRIVATE5', 'DISPID_SMSALineId',
    'DISPID_SVAlertBoundary', 'SPSNoun', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPPs_NewEnum', 'SVP_13', 'SRSInactive',
    'DISPID_SpeechPhraseInfo', 'SPVPRIORITY', 'SSFMOpenReadWrite',
    'DISPID_SGRsCommit', 'DISPID_SRCRecognizer', 'SPAS_PAUSE',
    'ISpeechRecognizer', 'SAFTGSM610_44kHzMono', 'SECFIgnoreWidth',
    'DISPID_SRCRetainedAudio', 'ISpeechVoice', 'SpCustomStream',
    ...
    'SRTSMLTimeout', 'SRERequestUI', 'SGLexicalNoSpecialChars',
    'DISPID_SVSpeak', 'DISPID_SPEAudioSizeBytes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SMSGetData',
    'SP_VISEME_12', 'SP_VISEME_10', 'SPEI_VISEME',
    'SPDKL_CurrentUser', 'DISPID_SRCAudioInInterferenceStatus',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechPhraseReplacement',
    'SpeechRuleAttributes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SECHighConfidence', 'DISPID_SGRSTPropertyValue', 'SVEAudioLevel',
    'ISpeechObjectTokenCategory', 'SECFDefault', 'SAFT22kHz8BitMono',
    'SPWAVEFORMATTYPE', 'SPEI_END_INPUT_STREAM', 'DISPID_SAFGuid',
    'STCLocalServer', 'IInternetSecurityManager', 'STCInprocServer',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechRecoProfileProperties',
    'DISPID_SRRTOffsetFromStart', 'SDTProperty',
    'DISPID_SPPNumberOfElements', 'SpeechVoicePriority',
    'DISPID_SVSInputSentenceLength', 'SPPS_RESERVED1',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRDisplayUI',
    'ISpeechVoiceStatus', 'SpNotifyTranslator', 'SPLOADOPTIONS',
    'DISPID_SpeechLexiconProns', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCVoice', 'SpeechPropertyLowConfidenceThreshold',
    'SPSUnknown', 'SPBO_NONE', 'SPEI_REQUEST_UI',
    'ISpObjectWithToken', 'DISPID_SAEventHandle', 'SPEI_PHONEME',
    'DISPID_SPPParent', 'DISPID_SVSInputWordPosition',
    'DISPID_SPEActualConfidence', 'SPRS_ACTIVE', 'ISpRecoContext',
    'DISPID_SRRSaveToMemory', 'SP_VISEME_2', 'SDTAlternates',
    'ISpSerializeState', 'SAFTCCITT_ALaw_22kHzStereo', 'DISPIDSPRG',
    'SPAS_CLOSED', 'SP_VISEME_9', 'eLEXTYPE_PRIVATE7',
    'SpMMAudioEnum', 'DISPID_SRCEEndStream', 'DISPID_SGRName',
    'SpPhoneticAlphabetConverter', 'SP_VISEME_0',
    'DISPID_SRGetFormat', 'SPSLMA', 'SVSFParseAutodetect',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPSEMANTICERRORINFO',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SDKSetLongValue',
    'STSF_LocalAppData', 'ISpeechDataKey', 'SITooQuiet',
    'eLEXTYPE_RESERVED4', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRIsShared',
    'SAFT22kHz16BitStereo', 'SREStateChange', 'DISPID_SVSPhonemeId',
    'DISPID_SBSFormat', 'ISpeechPhraseInfoBuilder',
    'SPEI_TTS_BOOKMARK', 'SVP_8', 'SPBO_AHEAD',
    'DISPID_SVEVoiceChange', 'SPPS_RESERVED3',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SOTGetAttribute',
    'SRTEmulated', 'DISPID_SOTDisplayUI', 'SPEI_MAX_TTS',
    'SPWORDPRONUNCIATION', 'DISPID_SPRuleConfidence',
    'SpeechGrammarState', 'SpeechTokenValueCLSID',
    'SpeechCategoryRecognizers', 'DISPID_SLWsCount', 'SPAO_NONE',
    'DISPID_SpeechVoice', 'SpNullPhoneConverter', 'SPAUDIOSTATUS',
    'DISPID_SDKDeleteKey', 'DISPID_SRRTimes', 'SRSEIsSpeaking',
    'SRSActiveAlways', 'SASPause', 'SPDATAKEYLOCATION',
    'SPEI_SR_PRIVATE', 'DISPID_SPRuleNumberOfElements', 'SPEVENTENUM',
    'DISPIDSPTSI_ActiveOffset', 'SPPS_SuppressWord',
    'SPEI_WORD_BOUNDARY', 'SRESoundEnd', 'DISPID_SGRSTPropertyId',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRTStreamTime',
    'DISPID_SPPValue', 'DISPID_SOTCId', 'SpSharedRecognizer',
    'SPEI_VOICE_CHANGE', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechLexiconWords', 'SLODynamic', 'SRTStandard',
    'SPFM_OPEN_READONLY', 'DISPIDSPTSI_SelectionOffset',
    'SVSFlagsAsync', 'SAFTADPCM_44kHzMono', 'SAFT12kHz16BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SLPPhoneIds',
    'SpeechVoiceSkipTypeSentence', 'SPBOOKMARKOPTIONS',
    '_ISpeechRecoContextEvents', 'SPRST_ACTIVE', 'DISPID_SOTRemove',
    'DISPID_SGRClear', 'DISPID_SWFEChannels', 'ISpeechGrammarRule',
    'SPRECOGNIZERSTATUS', 'DISPID_SDKGetlongValue',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVSpeakStream',
    'SPPS_Function', 'eLEXTYPE_RESERVED9', 'DISPID_SRRAlternates',
    'eLEXTYPE_PRIVATE17', 'SPPARTOFSPEECH', 'DISPID_SPRulesCount',
    'SpeechPropertyResourceUsage', 'DISPID_SRSCurrentStreamPosition',
    'SpeechDataKeyLocation', 'DISPID_SLAddPronunciation',
    'DISPID_SRSetPropertyNumber', 'DISPID_SOTIsUISupported',
    'SPPS_Unknown', 'ISpRecoResult', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPCPhoneToId', 'ISpEventSink', 'SP_VISEME_19',
    'SpeechLexiconType', 'SPEI_MAX_SR', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVEPhoneme', 'DISPID_SRCERecognition',
    'DISPID_SRCEInterference', 'DISPID_SRRAudio', 'SREPhraseStart',
    'DISPID_SAFType', 'DISPID_SABIEventBias',
    'DISPID_SASCurrentSeekPosition', 'SVEWordBoundary',
    'SRCS_Enabled', 'SVSFNLPSpeakPunc', 'eLEXTYPE_PRIVATE20',
    'SREHypothesis', 'SPGRAMMARSTATE', 'DISPID_SPPId',
    'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE3', 'SVP_20',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCreateRecoContext',
    'ISpeechRecoResultTimes', 'ISpeechRecoContext', 'SPEI_MIN_TTS',
    'SAFT16kHz8BitMono', 'SpeechTokenKeyFiles',
    'DISPID_SDKGetStringValue', 'SPAS_STOP', 'DISPID_SMSSetData',
    'DISPID_SRCResume', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SLPs_NewEnum', 'SpeechAudioProperties', 'DISPID_SVSkip',
    'SAFTNoAssignedFormat', 'SPGS_ENABLED', 'SPSHT_Unknown',
    'IStream', 'ISpeechLexiconWords', 'DISPID_SPEAudioSizeTime',
    'SPSHT_EMAIL', 'SpeechTokenContext', 'DISPID_SPIAudioSizeTime',
    'DISPID_SLGetGenerationChange', 'DISPID_SPPConfidence',
    'SAFTText', 'SPWT_PRONUNCIATION', 'ISpeechResourceLoader',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPVPRI_ALERT',
    'SpeechRuleState', 'SREFalseRecognition', 'ISpeechAudio',
    'DISPID_SLWsItem', 'DISPID_SPAs_NewEnum', 'SVSFPurgeBeforeSpeak',
    'SpeechUserTraining', 'DISPID_SOTCGetDataKey', 'SVPAlert',
    'DISPID_SpeechMemoryStream', 'ISpStreamFormatConverter',
    'DISPIDSPTSI_SelectionLength', 'SpeechAudioVolume',
    'DISPID_SLGetPronunciations', 'SpAudioFormat',
    'SPPS_Interjection', 'SPXRO_Alternates_SML',
    'SAFTCCITT_ALaw_11kHzMono', 'SPINTERFERENCE_TOOLOUD',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SBONone', 'IEnumSpObjectTokens',
    'DISPID_SPAStartElementInResult', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SGRSTNextState', 'SREAudioLevel', 'SRTExtendableParse',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPWORD',
    'Speech_Max_Pron_Length', 'DISPID_SGRSRule',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPERequiredConfidence', 'SPEVENT', 'SPAUDIOBUFFERINFO',
    'SAFT8kHz16BitStereo', 'SSFMCreateForWrite',
    'SpeechTokenIdUserLexicon', 'DISPID_SOTCSetId',
    'DISPID_SLPSymbolic', 'DISPID_SpeechAudioFormat',
    'SPEI_ADAPTATION', 'ISpGrammarBuilder', 'SRAORetainAudio',
    'ISpVoice', 'ISpeechAudioFormat', 'DISPID_SRSClsidEngine',
    'DISPID_SWFEAvgBytesPerSec', 'SPGS_DISABLED', 'DISPID_SGRId',
    'eLEXTYPE_RESERVED7', 'DISPID_SOTs_NewEnum', 'SPRECOSTATE',
    'ISpDataKey', 'SREPropertyStringChange', 'Speech_Default_Weight',
    'SAFT11kHz16BitStereo', 'DISPID_SGRsFindRule', 'DISPID_SGRSTType',
    'SVEPrivate', 'DISPID_SPRFirstElement', 'ISpeechPhraseRule',
    'DISPID_SMSADeviceId', 'SPBO_TIME_UNITS', 'SGRSTTDictation',
    'SP_VISEME_20', 'SAFT8kHz8BitStereo',
    'DISPID_SREmulateRecognition', 'DISPID_SRSetPropertyString',
    'eLEXTYPE_PRIVATE16', 'SpObjectToken', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPCLangId', 'SpWaveFormatEx', 'SPVPRI_NORMAL',
    'DISPID_SPIAudioStreamPosition', 'SLTUser', 'DISPID_SLWs_NewEnum',
    'SAFT44kHz8BitStereo', 'SPEI_SR_BOOKMARK', 'DISPID_SRCERequestUI',
    'SpCompressedLexicon', 'SRAImport', 'ISpLexicon',
    'SAFTGSM610_8kHzMono', 'DISPID_SRCEBookmark',
    'DISPID_SRCEventInterests', 'DISPID_SpeechWaveFormatEx',
    'IEnumString', 'SAFT12kHz16BitStereo', 'SpeechCategoryVoices',
    'SITooSlow', 'DISPID_SRGReset', 'ISpeechRecoResult',
    'DISPID_SPIElements', 'DISPID_SRGId', 'DISPID_SpeechDataKey',
    'SPCT_DICTATION', 'SPAS_RUN', 'DISPID_SRCEPhraseStart',
    'SPEI_SOUND_END', 'DISPID_SpeechRecoContextEvents',
    'SPSEMANTICFORMAT', 'SPEI_SR_RETAINEDAUDIO', 'ISpeechObjectToken',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechPhraseReplacements', 'ISpeechCustomStream',
    'DISPID_SPACommit', 'SVSFUnusedFlags', 'DISPID_SPIReplacements',
    'SPPHRASEELEMENT', 'SpeechWordPronounceable',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechGrammarRule',
    'DISPID_SFSClose', 'SRTAutopause',
    'SpeechGrammarTagUnlimitedDictation', 'SRAONone', 'SVF_None',
    'SP_VISEME_6', 'SAFT32kHz16BitStereo',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRGCmdSetRuleState',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRRAudioFormat',
    'DISPID_SWFEBitsPerSample', 'eLEXTYPE_PRIVATE15',
    'DISPID_SAFGetWaveFormatEx', 'SVP_18',
    'DISPID_SpeechCustomStream', 'SAFT32kHz8BitMono',
    'SPDKL_LocalMachine', 'ISpeechGrammarRuleState',
    'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE19',
    'eLEXTYPE_PRIVATE18', 'ISpeechTextSelectionInformation',
    'ISpResourceManager', 'ISequentialStream', 'DISPID_SRStatus',
    'SPGRAMMARWORDTYPE', 'DISPID_SBSRead', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPPsCount', 'SPEI_HYPOTHESIS', 'DISPID_SGRSTText',
    'DISPID_SABufferInfo', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechObjectTokens', 'SINone', 'SpeechRecoEvents',
    'DISPID_SPIRule', 'SVSFIsNotXML', 'SpeechRegistryUserRoot',
    'SAFT48kHz16BitMono', 'DISPID_SGRAddState', 'eLEXTYPE_PRIVATE13',
    ...
    'eLEXTYPE_PRIVATE6', 'SAFT16kHz16BitStereo', 'DISPID_SFSOpen',
    ...
    'eLEXTYPE_PRIVATE2', 'ISpShortcut', 'SPVOICESTATUS',
    'SAFT22kHz8BitStereo', 'SAFT12kHz8BitStereo',
    'DISPID_SRRecognizer', 'DISPID_SpeechObjectTokens',
    'ISpeechPhraseReplacement', 'DISPID_SGRSTsCount',
    'DISPID_SPRuleName', 'DISPID_SWFESamplesPerSec',
    ...
    'SPPS_RESERVED4', 'DISPID_SpeechLexicon', 'SPFM_OPEN_READWRITE',
    'SpeechRecognitionType', 'SPWORDLIST', 'SITooFast',
    'SPEI_TTS_AUDIO_LEVEL', 'SPCT_SLEEP', 'SVP_12', 'SRTReSent',
    'SPEI_SR_AUDIO_LEVEL', 'SpMMAudioIn', 'SPSERIALIZEDRESULT',
    'DISPID_SDKEnumValues', 'SpeechVisemeFeature',
    'DISPID_SVAudioOutput', 'tagSPPROPERTYINFO', 'SpMMAudioOut',
    'SPPHRASERULE', 'SAFTCCITT_uLaw_22kHzStereo', 'SPVPRI_OVER',
    'SAFT8kHz8BitMono', 'SPCONTEXTSTATE', 'SECNormalConfidence',
    'DISPID_SDKSetBinaryValue', 'SpPhoneConverter', 'SPWORDTYPE',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechPhraseRules',
    'ISpRecognizer', 'DISPID_SRGIsPronounceable', 'SVF_Stressed',
    'SPCT_SUB_COMMAND', 'DISPID_SMSAMMHandle',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPELexicalForm',
    'ISpProperties', 'SDKLCurrentConfig', 'SpeechVoiceEvents',
    'DISPID_SLGenerationId', 'SVSFParseSapi', 'SPSFunction',
    'SGSEnabled', 'ISpRecoContext2', 'DISPID_SpeechRecognizer',
    'SPDKL_CurrentConfig', 'DISPID_SOTCEnumerateTokens',
    'ISpeechXMLRecoResult',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRSAddWordTransition', 'SVP_3', 'SVP_6',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPPChildren',
    'SAFT16kHz8BitStereo', 'SPRST_ACTIVE_ALWAYS', 'SVSFDefault',
    'SpeechTokenKeyUI', 'DISPID_SVStatus', 'SPEI_END_SR_STREAM',
    'SAFT48kHz16BitStereo', 'DISPID_SABIBufferSize', 'DISPID_SGRsAdd',
    'SPDKL_DefaultLocation', 'DISPID_SVEStreamStart', 'SDTRule',
    'DISPID_SPAsCount', 'DISPID_SRCEStartStream',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechDictationTopicSpelling', 'SGLexical', 'DISPID_SLWLangId',
    'SASRun', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPERetainedSizeBytes', 'SAFT32kHz16BitMono',
    'DISPID_SPEDisplayText', 'SpInProcRecoContext',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SOTId',
    'DISPID_SRGRules', 'SAFT11kHz8BitMono',
    'DISPID_SRSCurrentStreamNumber', 'ISpRecoGrammar2',
    'DISPID_SLPType', 'DISPID_SRGCmdSetRuleIdState',
    'STSF_CommonAppData', 'SAFTDefault', 'DISPID_SPEsCount',
    'DISPID_SLWWord', 'SGRSTTWildcard', 'DISPID_SLPsCount',
    'SAFT32kHz8BitStereo', 'SPRST_INACTIVE', 'SPSTREAMFORMATTYPE',
    'ISpeechGrammarRules', 'DISPID_SpeechRecoResult2',
    'SpObjectTokenCategory', 'DISPID_SPPsItem', 'ISpNotifySink',
    'DISPID_SDKOpenKey', 'DISPID_SOTsItem', 'DISPID_SpeechRecoResult',
    'DISPID_SPRsItem', 'SPINTERFERENCE_NONE', 'SP_VISEME_13',
    'SGRSTTTextBuffer', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhoneConverter', 'ISpAudio', 'LONG_PTR',
    'SPWF_INPUT', 'DISPID_SpeechObjectToken',
    'SAFTExtendedAudioFormat', 'SpeechInterference', 'SP_VISEME_8',
    'SPADAPTATIONRELEVANCE', 'DISPID_SGRsItem',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRSTRule', 'SVPNormal',
    'SpPhraseInfoBuilder', 'SPPS_Noncontent', 'SPEI_RESERVED3',
    'SDTLexicalForm', 'SAFTADPCM_11kHzMono', 'SVP_7',
    'DISPID_SRGDictationSetState', 'WAVEFORMATEX',
    'eWORDTYPE_DELETED', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechXMLRecoResult', 'ISpPhrase',
    'DISPID_SVSVisemeId', 'SpeechAudioFormatGUIDText', 'SP_VISEME_17',
    'SPSModifier', 'SPPS_LMA', 'DISPID_SVPause', 'SPEI_MIN_SR',
    'SPSSuppressWord', 'STCRemoteServer', 'SPEI_RECO_STATE_CHANGE',
    'SVP_11', 'SGSDisabled', 'DISPID_SGRAttributes',
    'DISPID_SVGetAudioInputs', 'SPWT_LEXICAL',
    'ISpeechPhraseReplacements', 'SVP_14',
    'SWPUnknownWordPronounceable', 'DISPID_SVPriority', 'SINoise',
    'SAFT24kHz8BitStereo', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechGrammarRules', 'SpResourceManager',
    'SSSPTRelativeToStart', 'SPSHT_OTHER',
    'SpeechPropertyResponseSpeed', 'SPAR_Unknown', 'SVPOver',
    'DISPID_SpeechVoiceEvent', 'DISPID_SPEEngineConfidence',
    'DISPID_SOTGetStorageFileName', 'SpeechBookmarkOptions',
    'DISPID_SVIsUISupported', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechPhraseElement', 'DISPID_SVGetVoices', 'SVSFParseSsml',
    'DISPID_SOTDataKey', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTNonStandardFormat', 'SRSEDone',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPRuleId',
    'DISPID_SRGetPropertyString', 'SP_VISEME_7', 'SPCS_ENABLED',
    'DISPID_SRCRequestedUIType', 'SGSExclusive', 'ISpMMSysAudio',
    ...
    'ISpXMLRecoResult', 'SPLEXICONTYPE',
    'DISPID_SVSInputSentencePosition', 'SPEI_RESERVED5',
    'SAFT48kHz8BitStereo', 'SVP_15', 'DISPID_SVEBookmark',
    'IInternetSecurityMgrSite', 'DISPID_SRCEAdaptation', 'SGRSTTWord',
    'DISPID_SDKDeleteValue', 'SpLexicon', 'SAFT24kHz16BitMono',
    'DISPID_SABIMinNotification', 'DISPID_SpeechPhraseBuilder',
    'ISpeechRecoResultDispatch', 'SAFT11kHz16BitMono',
    'STCInprocHandler', 'DISPID_SRCEHypothesis',
    'DISPID_SASFreeBufferSpace', 'SPLO_STATIC', 'SpeechRunState',
    'SpeechStreamFileMode', 'SVP_4', 'SP_VISEME_3', 'SVEAllEvents',
    'SPSNotOverriden', 'SpeechEngineConfidence', 'STCAll',
    'SAFTADPCM_22kHzMono', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRGDictationLoad', 'DISPID_SGRSAddRuleTransition',
    'SDKLLocalMachine', 'SPINTERFERENCE_NOISE', 'DISPID_SPEsItem',
    'DISPID_SPPName', 'SSTTWildcard', 'DISPID_SOTCDefault',
    'ISpeechAudioBufferInfo', 'SPFM_CREATE', 'ISpObjectTokenCategory',
    'DISPID_SGRSTsItem', 'SGPronounciation', 'SPSVerb',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPAPhraseInfo', 'SREStreamEnd', 'DISPID_SPARecoResult',
    'SpShortcut', 'SpeechGrammarWordType',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_PRIVATE9',
    'SpeechAudioState', 'DISPID_SRGRecoContext',
    'Speech_Max_Word_Length', 'SSTTTextBuffer', 'DISPID_SLGetWords',
    'SP_VISEME_4', 'SPPHRASEREPLACEMENT', 'DISPID_SASetState',
    'DISPID_SRCCreateGrammar',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPPBRestorePhraseFromMemory'
]

_check_version('1.2.0', 1700067338.019388)
