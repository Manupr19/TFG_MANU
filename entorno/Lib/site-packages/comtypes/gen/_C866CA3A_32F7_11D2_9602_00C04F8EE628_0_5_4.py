...
__all__ = [
    ...
    'SPAUDIOBUFFERINFO', 'SAFT11kHz8BitStereo',
    'DISPID_SGRSTransitions', 'DISPID_SADefaultFormat',
    'SDTLexicalForm', 'DISPID_SVDisplayUI',
    'DISPID_SRRDiscardResultInfo', 'SREStateChange',
    'SDKLCurrentUser', 'SVP_18', 'SVP_19', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRsCount', 'DISPID_SGRSTWeight',
    'DISPID_SPPFirstElement', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT8kHz16BitStereo', 'SpNotifyTranslator',
    'DISPID_SVSRunningState', 'ISpRecoCategory', 'SVPAlert',
    'SpFileStream', 'SAFTGSM610_44kHzMono', 'SpeechInterference',
    'DISPID_SRCEAdaptation', 'DISPID_SGRInitialState', 'DISPID_SPPId',
    'SVPNormal', 'SpeechAddRemoveWord', 'SDA_One_Trailing_Space',
    'SVSFIsXML', 'STCRemoteServer', 'DISPID_SAEventHandle',
    'eLEXTYPE_PRIVATE2', 'ISpeechWaveFormatEx',
    'DISPID_SPIEnginePrivateData', 'ISpeechRecoResult2',
    'SpObjectToken', 'SpeechVisemeType', 'SAFTNonStandardFormat',
    'DISPID_SRGId', 'DISPID_SWFEBlockAlign',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechPhraseAlternates',
    'DISPID_SRIsShared', 'SRAExport', 'SPPS_Unknown', 'SpLexicon',
    'DISPID_SBSRead', 'SPEI_RESERVED3', 'SpeechVoicePriority',
    'SpStream', 'SPRECOGNIZERSTATUS', 'SGSExclusive',
    'DISPID_SPERetainedStreamOffset', 'SPEI_END_INPUT_STREAM',
    'SITooQuiet', 'DISPID_SVRate', 'ISpeechObjectTokens',
    'SpeechDictationTopicSpelling', 'ISpRecoContext',
    'ISpeechVoiceStatus', 'SPAR_High', 'IEnumString',
    'DISPID_SPPNumberOfElements', 'SPBOOKMARKOPTIONS',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpMMSysAudio',
    'SP_VISEME_6', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRCERecognizerStateChange', 'ISpStreamFormatConverter',
    'DISPID_SRGetPropertyString', 'DISPID_SpeechGrammarRule',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCEAudioLevel',
    'SPINTERFERENCE_TOOSLOW', 'SAFT32kHz16BitMono', 'SINone',
    'ISpeechMemoryStream', 'DISPID_SRCEventInterests',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCResume',
    'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVGetProfiles', 'DISPID_SRCVoice', 'SGRSTTWildcard',
    'DISPID_SVEViseme', 'DISPID_SOTGetAttribute', 'SPSUnknown',
    'SVP_11', 'SPINTERFERENCE_NONE', 'DISPID_SpeechPhraseAlternates',
    'SpeechAudioState', 'SPSInterjection', 'SVEBookmark',
    'SAFTCCITT_ALaw_8kHzMono', 'SPSHORTCUTTYPE', 'eWORDTYPE_ADDED',
    'DISPID_SOTCSetId', 'DISPID_SVSInputWordPosition', 'SDTProperty',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPAsCount', 'ISpPhrase',
    'DISPID_SPELexicalForm', 'SFTInput', 'SPGS_DISABLED',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVESentenceBoundary',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVEStreamStart', 'SVP_1',
    'DISPID_SpeechLexicon', 'eLEXTYPE_VENDORLEXICON', 'SPPS_Function',
    'DISPID_SCSBaseStream', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRGRecoContext', 'DISPID_SRRPhraseInfo', 'ISpeechLexicon',
    'SPEI_MIN_TTS', 'SREFalseRecognition',
    'DISPID_SpeechCustomStream', 'SGSDisabled', 'SVPOver',
    'ISpeechLexiconPronunciation', 'SRESoundStart', 'SpAudioFormat',
    'ISpObjectToken', 'SDA_Consume_Leading_Spaces', 'SPWORDTYPE',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechRecoResultTimes',
    'SVSFNLPSpeakPunc', 'SpeechPropertyResourceUsage',
    'SAFT16kHz8BitMono', 'SpPhoneticAlphabetConverter',
    'DISPID_SAFSetWaveFormatEx', 'SpeechLoadOption', 'SPFM_NUM_MODES',
    'SAFTGSM610_11kHzMono', '_ISpeechVoiceEvents', 'SVSFVoiceMask',
    'SPWT_LEXICAL', 'SPSEMANTICFORMAT', 'SRADefaultToActive',
    'DISPID_SBSSeek', 'SPADAPTATIONRELEVANCE', 'DISPID_SLWsItem',
    '_RemotableHandle', 'SPSNoun', 'DISPID_SDKEnumKeys',
    'DISPID_SPERetainedSizeBytes', 'SpeechCategoryVoices',
    'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechLexiconWords', 'DISPID_SPAs_NewEnum', 'SGRSTTRule',
    'DISPID_SBSWrite', 'DISPID_SPCPhoneToId', 'SVEAudioLevel',
    'SPSModifier', 'eLEXTYPE_RESERVED4',
    'SpeechPropertyResponseSpeed', 'WAVEFORMATEX',
    'SAFTADPCM_22kHzMono', 'SVSFNLPMask', 'SPTEXTSELECTIONINFO',
    'DISPID_SGRClear', 'SLOStatic', 'SpeechPropertyAdaptationOn',
    'SSFMCreate', 'SP_VISEME_2', 'DISPID_SRGDictationLoad',
    'ISpeechPhraseProperty', 'IStream', 'SAFT44kHz16BitStereo',
    'SPPS_NotOverriden', 'SPCS_ENABLED', 'DISPID_SVEVoiceChange',
    'DISPIDSPTSI', 'SVF_None', 'SWPKnownWordPronounceable',
    'DISPID_SRCCreateResultFromMemory', 'ISpNotifyTranslator',
    'SpeechPartOfSpeech', 'DISPID_SPPChildren', 'SWTAdded',
    'DISPID_SPEAudioSizeBytes', 'SECFNoSpecialChars',
    'DISPID_SLGetWords', 'SPDKL_CurrentUser', 'ISpeechPhraseRules',
    ...
    'SRTAutopause', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPEAudioTimeOffset', 'SRSEDone', 'SVP_7',
    'DISPID_SPRulesItem', 'SGSEnabled', 'eLEXTYPE_PRIVATE9',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechRecoResult',
    'DISPID_SPEsCount', 'SGRSTTTextBuffer',
    'SpeechVoiceCategoryTTSRate', 'SPPROPERTYINFO', 'SASRun',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SABufferInfo',
    'DISPID_SRCreateRecoContext', 'SpeechTokenContext', 'SRTReSent',
    'ISpeechAudio', 'SpeechAudioProperties', '__MIDL_IWinTypes_0009',
    'SPRST_NUM_STATES', 'SpeechCategoryAudioIn', 'DISPID_SFSOpen',
    'SDA_No_Trailing_Space', 'DISPID_SpeechAudio',
    'DISPID_SVSInputSentenceLength', 'SAFT11kHz16BitMono',
    'ISpPhoneConverter', 'SGLexical', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SOTCreateInstance', 'SpeechEngineProperties',
    'SAFT12kHz8BitStereo', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SGRSTs_NewEnum', 'SPCS_DISABLED', 'ISpeechPhraseElements',
    'DISPID_SVResume', 'SSTTDictation', 'DISPID_SpeechDataKey',
    'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_RESERVED8',
    'SAFT48kHz8BitStereo', 'DISPID_SRGetPropertyNumber',
    'SPCT_SUB_COMMAND', 'DISPID_SRSetPropertyNumber',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVPriority',
    'SP_VISEME_7', 'SAFT8kHz8BitStereo', 'SPEI_TTS_PRIVATE',
    'DISPID_SGRId', 'ISpeechPhoneConverter',
    ...
    'DISPID_SpeechVoiceStatus', 'SREPrivate',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechAudioFormat', 'SVP_4',
    'ISpeechLexiconWords', 'DISPID_SDKDeleteKey',
    'SpeechGrammarTagWildcard', 'SDTAlternates', 'SPEI_MAX_SR',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechAudioBufferInfo',
    'ISpPhoneticAlphabetConverter', 'DISPID_SDKSetStringValue',
    '_ISpeechRecoContextEvents', 'DISPID_SPEEngineConfidence',
    'SpeechDisplayAttributes', 'DISPID_SPEDisplayText',
    'DISPID_SLGetGenerationChange', 'SPSMF_UPS', 'SRADynamic',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPRuleParent',
    'DISPID_SRDisplayUI', 'SpeechRuleAttributes',
    'DISPID_SVSLastBookmark', 'DISPID_SOTCEnumerateTokens',
    'SPBO_TIME_UNITS', 'DISPID_SRCEEnginePrivate', 'SREPhraseStart',
    'SSFMCreateForWrite', 'SPPS_SuppressWord', 'SPEI_RESERVED5',
    'SpeechVisemeFeature', 'SPBINARYGRAMMAR', 'SPSSuppressWord',
    'SGRSTTDictation', 'SVSFParseAutodetect',
    'SGLexicalNoSpecialChars', 'SAFT22kHz16BitStereo',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SREmulateRecognition',
    'DISPID_SVGetVoices', 'DISPID_SPIGetDisplayAttributes',
    'Speech_StreamPos_RealTime', 'SPVISEMES', 'SAFT48kHz16BitStereo',
    'SVSFParseSapi', 'SP_VISEME_16', 'DISPID_SRGetFormat',
    'SpeechGrammarTagDictation', 'SAFTTrueSpeech_8kHz1BitMono',
    'SP_VISEME_20', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechPhraseElement', 'SASStop', 'SAFT22kHz16BitMono',
    'SPLOADOPTIONS', 'SRAImport', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SGRSTRule', 'SP_VISEME_8', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCRetainedAudio', 'DISPID_SPEsItem',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechFileStream', 'DISPID_SVSpeak', 'DISPID_SRState',
    'SDTDisplayText', 'DISPID_SRSetPropertyString', 'SPXRO_SML',
    'DISPID_SLGetPronunciations', 'SPWORDPRONOUNCEABLE',
    'SPRECOCONTEXTSTATUS', 'SPAR_Unknown', 'SPRECORESULTTIMES',
    'SPEI_PHRASE_START', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVEPhoneme', 'DISPID_SRRecognizer', 'DISPID_SRGRules',
    'DISPID_SPCIdToPhone', 'SECNormalConfidence',
    'DISPID_SVEventInterests', 'SPBO_PAUSE', 'SpeechEngineConfidence',
    'DISPID_SGRSTPropertyName', 'DISPID_SPEs_NewEnum',
    'DISPID_SPRsCount', 'SVP_14', 'DISPID_SRRSetTextFeedback',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechAudioFormatGUIDText',
    'SVSFDefault', 'SASPause', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPRs_NewEnum', 'eLEXTYPE_PRIVATE7', 'DISPID_SPIGetText',
    'DISPID_SPAPhraseInfo', 'ISpStream', 'SAFT24kHz8BitMono',
    'SPEI_VOICE_CHANGE', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPRuleFirstElement', 'SPEI_FALSE_RECOGNITION',
    'SPVPRI_NORMAL', 'DISPID_SRGIsPronounceable', 'DISPID_SPIRule',
    'SPRECOSTATE', 'DISPID_SPIReplacements', 'STCLocalServer',
    'SRARoot', 'SREStreamStart', 'SpWaveFormatEx',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_APP', 'DISPID_SVVoice',
    'SPAO_RETAIN_AUDIO', 'SPLO_DYNAMIC', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRSClsidEngine', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPRsItem',
    'SpeechRecoProfileProperties', 'ISpeechResourceLoader',
    'DISPID_SLWsCount', 'SPAS_PAUSE', 'eLEXTYPE_PRIVATE17',
    'SAFT32kHz8BitStereo', 'SDA_Two_Trailing_Spaces', 'SPAO_NONE',
    'ISpVoice', 'DISPID_SRGReset', 'SPINTERFERENCE',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRAudioInputStream', 'ISpeechLexiconPronunciations',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SDKGetlongValue',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPEAudioSizeTime', 'SP_VISEME_1', 'SAFT32kHz8BitMono',
    'SRERecoOtherContext', 'SVSFIsNotXML', 'SSSPTRelativeToEnd',
    'SREBookmark', 'SPPS_RESERVED4', 'DISPID_SGRs_NewEnum',
    'DISPID_SPPs_NewEnum', 'DISPID_SPIStartTime',
    'SpeechUserTraining', 'ISpeechPhraseAlternate',
    'SPDKL_DefaultLocation', 'DISPID_SRGCmdLoadFromObject',
    'IEnumSpObjectTokens', 'SPCT_SLEEP', 'DISPID_SABIBufferSize',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpSharedRecognizer',
    'DISPID_SAFGetWaveFormatEx', 'SPSVerb', 'DISPID_SRRSpeakAudio',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SREHypothesis',
    'SpMMAudioIn', 'SpeechDiscardType', 'DISPID_SVStatus',
    'DISPID_SLGenerationId', 'SpObjectTokenCategory',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRSSupportedLanguages',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SMSAMMHandle', 'SVP_13',
    'DISPID_SDKEnumValues', 'ISpeechGrammarRuleState',
    'SRTExtendableParse', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRSTsCount', 'SSTTWildcard', 'SpeechStreamFileMode',
    'DISPID_SOTDisplayUI', 'SPGRAMMARWORDTYPE', 'ISpStreamFormat',
    'SPPS_LMA', 'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE15',
    'SAFT11kHz16BitStereo', 'SAFT24kHz16BitMono',
    'eLEXTYPE_PRIVATE12', 'ISpEventSource', 'DISPID_SRCCreateGrammar',
    'SPDKL_LocalMachine', 'DISPID_SRCEPhraseStart',
    'SSFMOpenReadWrite', 'SPPHRASEELEMENT', 'ISpeechRecognizerStatus',
    'DISPID_SVEBookmark', 'DISPID_SPAsItem', 'ISpPhraseAlt',
    'DISPID_SVSLastResult', 'SVP_5',
    ...
    'SpeechTokenKeyFiles', 'SAFT16kHz16BitMono', 'STSF_FlagCreate',
    'DISPID_SPACommit', 'DISPID_SRGCmdLoadFromMemory',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SOTs_NewEnum', 'SPSHORTCUTPAIRLIST', 'SPPHRASERULE',
    'ISpeechGrammarRule', 'SpeechTokenKeyUI', 'DISPID_SRRTLength',
    'DISPID_SPAStartElementInResult', 'UINT_PTR', 'DISPID_SAFType',
    'ISpRecognizer', 'SPPS_RESERVED3', 'SPEI_RESERVED6',
    'eLEXTYPE_RESERVED6', 'SECFEmulateResult', 'ISpRecoContext2',
    'DISPID_SVEAudioLevel', 'SAFT16kHz8BitStereo',
    'DISPID_SVGetAudioOutputs', 'SPSTREAMFORMATTYPE', 'SPPHRASE',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCRecognizer', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechRecognizerState', 'SAFT22kHz8BitMono',
    'eLEXTYPE_PRIVATE11', 'SGRSTTWord', 'SPEVENT', 'SPAR_Medium',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPVOICESTATUS',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPPsItem', 'SPEVENTENUM',
    'SAFT11kHz8BitMono', 'DISPID_SpeechBaseStream',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_INTERFERENCE',
    'DISPID_SWFEFormatTag', 'SAFTADPCM_11kHzMono',
    'SPFM_OPEN_READWRITE', 'ISpeechAudioBufferInfo', 'SPGS_EXCLUSIVE',
    'SVSFlagsAsync', 'DISPID_SOTCategory',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SOTIsUISupported',
    'SPRS_ACTIVE', 'SREPropertyStringChange', 'SpShortcut',
    'DISPID_SPEAudioStreamOffset', 'SpPhraseInfoBuilder',
    'DISPID_SRIsUISupported', 'SVP_16', 'SP_VISEME_17', 'DISPIDSPRG',
    'DISPID_SRRGetXMLResult', 'SECFDefault', 'Speech_Max_Pron_Length',
    'SAFT22kHz8BitStereo', 'DISPID_SDKSetLongValue',
    'SPEI_START_SR_STREAM', 'DISPID_SRRTOffsetFromStart', 'SPBO_NONE',
    'SVP_15', 'ISpRecoResult', 'DISPID_SPIRetainedSizeBytes',
    'SPPS_Noncontent', 'SpeechAllElements', 'SVP_8',
    'SPSHT_NotOverriden', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechCustomStream', 'DISPID_SpeechGrammarRuleState',
    'SpeechBookmarkOptions', 'SAFTNoAssignedFormat', 'DISPID_SLPType',
    'SPWF_INPUT', 'SAFT24kHz8BitStereo', 'SP_VISEME_0',
    'ISpeechMMSysAudio', 'SpUnCompressedLexicon', 'SP_VISEME_5',
    'DISPID_SOTMatchesAttributes', 'DISPID_SFSClose',
    'DISPID_SRCPause', 'SpTextSelectionInformation', 'SP_VISEME_14',
    'SpeechRunState', 'SpVoice', 'SPPHRASEREPLACEMENT',
    'ISpeechBaseStream', 'DISPID_SGRSTPropertyId', 'SPSHT_EMAIL',
    'SPSNotOverriden', 'DISPID_SPIElements', 'SINoSignal',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRGCmdSetRuleState',
    'ISpeechGrammarRules', 'SVP_10', 'SGRSTTEpsilon',
    'SPWORDPRONUNCIATIONLIST', 'SPINTERFERENCE_NOISE',
    'SVSFIsFilename', 'ISpRecognizer2', 'SPSERIALIZEDRESULT',
    'DISPID_SDKOpenKey', 'SRSActiveAlways', 'ISpEventSink',
    'DISPID_SPISaveToMemory', 'SpeechVoiceSpeakFlags',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechVoice',
    'SpeechCategoryRecognizers', 'ISpSerializeState',
    'DISPID_SVWaitUntilDone', 'DISPID_SLWPronunciations',
    'SRATopLevel', 'DISPID_SAFGuid', 'SITooLoud',
    'DISPIDSPTSI_SelectionOffset', 'SpeechStreamSeekPositionType',
    'eLEXTYPE_PRIVATE8',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTRemove',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLPLangId', 'SECFIgnoreCase',
    'DISPID_SVSyncronousSpeakTimeout', 'SPPS_Interjection',
    'DISPID_SRStatus', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechPhraseReplacements', 'DISPID_SRGDictationSetState',
    'DISPID_SLPPhoneIds', 'DISPID_SGRsDynamic',
    'DISPID_SRGDictationUnload', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVEWord', 'DISPID_SGRName',
    'ISpAudio', 'DISPID_SPPsCount', 'DISPID_SVPause',
    'SAFT32kHz16BitStereo', 'DISPID_SVGetAudioInputs',
    'SAFT8kHz16BitMono', 'ISpObjectTokenCategory',
    'DISPID_SRRRecoContext', 'SP_VISEME_15', 'SPBO_AHEAD',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE6', 'SpeechWordType', 'SpeechCategoryAudioOut',
    'SSFMOpenForRead', 'DISPID_SRGSetTextSelection', 'SpCustomStream',
    'SPPHRASEPROPERTY', 'DISPID_SPRNumberOfElements',
    'ISpeechDataKey', 'ISpeechGrammarRuleStateTransition', 'SVP_20',
    'SVSFPurgeBeforeSpeak', 'ISpeechRecoResultTimes',
    'SpeechRegistryUserRoot', 'DISPID_SRCBookmark', 'SPEI_ADAPTATION',
    'DISPID_SPIEngineId', 'SpNullPhoneConverter',
    'ISpeechAudioFormat', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRCVoicePurgeEvent', 'SpeechTokenKeyAttributes',
    'SpResourceManager', 'SAFT48kHz16BitMono', 'SAFT44kHz16BitMono',
    'ISpNotifySource', 'ISpPhoneticAlphabetSelection',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRCEHypothesis',
    'DISPID_SPCLangId', 'SpeechVoiceEvents', 'SPAR_Low',
    'DISPID_SRCERecognition', 'DISPIDSPTSI_SelectionLength',
    'SPAS_STOP', 'ISpResourceManager', 'DISPID_SGRSAddRuleTransition',
    'SPEI_HYPOTHESIS', 'SPAS_RUN', 'SVP_2', 'SSSPTRelativeToStart',
    'SVEVoiceChange', 'eLEXTYPE_USER', 'SBOPause', 'SP_VISEME_4',
    'SRTSMLTimeout', 'SECLowConfidence',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRSTText',
    'ISpeechObjectToken', 'SPEI_MIN_SR', 'SPCT_DICTATION',
    'SPVPRIORITY', 'DISPID_SpeechVoiceEvent', 'DISPID_SPPValue',
    'SPEI_WORD_BOUNDARY', 'ISpNotifySink', 'ISpeechXMLRecoResult',
    'SVSFPersistXML', 'SVP_0', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTGetStorageFileName', 'SAFT12kHz16BitMono',
    'DISPID_SGRSTsItem', 'DISPID_SPRText', 'SPEI_END_SR_STREAM',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRules_NewEnum',
    'SpeechGrammarRuleStateTransitionType',
    'ISpeechTextSelectionInformation', 'SLODynamic',
    'DISPID_SWFEAvgBytesPerSec', 'STCInprocServer', 'SVP_21',
    'DISPID_SWFESamplesPerSec', 'SECFIgnoreKanaType', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE16', 'SBONone', 'eLEXTYPE_PRIVATE5',
    'DISPID_SVAudioOutputStream', '_SPAUDIOSTATE', 'SGDSInactive',
    'SPEI_RECOGNITION', 'DISPID_SPRFirstElement',
    'SpInprocRecognizer', 'SPSHORTCUTPAIR',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFTText',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLWs_NewEnum',
    'SPFM_OPEN_READONLY', 'SP_VISEME_13', 'ISpXMLRecoResult',
    'DISPID_SOTSetId', 'DISPID_SASNonBlockingIO', 'SDTRule',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eWORDTYPE_DELETED',
    'SPAUDIOOPTIONS', 'SPDATAKEYLOCATION', 'DISPID_SGRSTType',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE20', 'SPRULESTATE',
    'DISPID_SLAddPronunciation', 'ISpeechPhraseInfoBuilder',
    'SAFT12kHz16BitStereo', 'SRAORetainAudio', 'ISpeechRecoContext',
    'SAFTDefault', 'SRESoundEnd', 'SREAllEvents',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SMSSetData', 'SFTSREngine', 'SP_VISEME_3', 'DISPID_SOTId',
    'DISPID_SLWLangId', 'DISPID_SLPs_NewEnum', 'SVP_17',
    'SAFT48kHz8BitMono', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRAttributes', 'SRCS_Disabled', 'ISpeechRecoResult',
    'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_19', 'DISPID_SLPsCount',
    'SLTApp', 'DISPID_SRAudioInput', 'DISPID_SVSkip',
    'SpPhoneConverter', 'SPCT_SUB_DICTATION', 'DISPID_SPRulesCount',
    'SPGS_ENABLED', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPXRO_Alternates_SML', 'SRSInactiveWithPurge',
    'DISPID_SWFEExtraData', 'DISPID_SGRAddState',
    'SpeechAudioFormatType', 'DISPID_SRCSetAdaptationData',
    'ISpeechLexiconWord', 'DISPID_SASetState', 'SPAS_CLOSED',
    'Speech_StreamPos_Asap', 'DISPID_SASFreeBufferSpace',
    'SDKLCurrentConfig', 'SPWT_PRONUNCIATION', 'SPWORD',
    'SPWORDPRONUNCIATION', 'ISpeechPhraseInfo',
    'DISPID_SPEActualConfidence', 'SRTEmulated',
    'SAFTADPCM_8kHzStereo', 'SPEI_REQUEST_UI', 'ISpRecoGrammar2',
    'tagSTATSTG', 'DISPID_SRCEInterference', 'SpeechFormatType',
    'SPEI_RESERVED2', 'SDTReplacement', 'SPSLMA', 'ISpShortcut',
    'DISPID_SpeechWaveFormatEx', 'SVP_3', 'SGDisplay',
    'DISPID_SRProfile', 'ISpeechVoice', 'SVP_6',
    'SpCompressedLexicon', 'DISPID_SPPEngineConfidence',
    'ISpeechPhraseRule', 'LONG_PTR', 'DISPID_SRRSaveToMemory',
    'eLEXTYPE_PRIVATE14', 'ISpeechAudioStatus', 'SRERequestUI',
    'IInternetSecurityManager', 'SAFTGSM610_22kHzMono',
    'DISPID_SMSADeviceId', 'DISPID_SGRAddResource', 'SRERecognition',
    'DISPID_SMSGetData', 'DISPID_SPRuleNumberOfElements',
    'Speech_Default_Weight', 'SPSHT_Unknown', 'SVSFUnusedFlags',
    'SSSPTRelativeToCurrentPosition', 'SDTPronunciation',
    'DISPID_SVSVisemeId', 'DISPID_SLPSymbolic', 'DISPID_SGRSRule',
    'SPPS_Verb', 'SPEI_SR_PRIVATE', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPRuleConfidence', 'SPEVENTSOURCEINFO',
    'ISequentialStream', 'SpeechGrammarWordType', 'SWTDeleted',
    'SVEAllEvents', 'ISpeechFileStream', 'SVEEndInputStream',
    'SDKLLocalMachine', 'SITooFast', 'SPSEMANTICERRORINFO',
    'SpeechDataKeyLocation', 'DISPID_SRCEBookmark', 'SREStreamEnd',
    'DISPID_SpeechPhraseRule', 'DISPID_SWFEBitsPerSample', 'SINoise',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SAVolume', 'SPRULE', 'DISPID_SVIsUISupported',
    'SPCONTEXTSTATE', 'DISPID_SpeechRecognizer',
    'SpStreamFormatConverter', 'DISPID_SRCESoundStart',
    'DISPID_SPPParent', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRGCommit', 'Speech_Max_Word_Length',
    'DISPID_SASCurrentDevicePosition', 'STCAll', 'SP_VISEME_9',
    'SPAUDIOSTATUS', 'SpeechTokenShellFolder', 'SAFTADPCM_8kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_9', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRRAudio', 'SP_VISEME_11', 'SECFIgnoreWidth',
    ...
    'DISPID_SABIEventBias', 'DISPID_SDKCreateKey', 'ISpRecoGrammar',
    'DISPID_SOTCId', 'SP_VISEME_12', 'ISpRecognizer3',
    'DISPID_SMSALineId', 'DISPID_SRSAudioStatus', 'SAFT44kHz8BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRSEIsSpeaking',
    'DISPID_SRRTStreamTime', 'eLEXTYPE_PRIVATE4',
    'SpeechTokenValueCLSID', 'ISpeechRecoGrammar', 'SPEI_UNDEFINED',
    'ISpeechRecognizer', 'DISPID_SVSpeakStream',
    'DISPID_SPPConfidence', 'SPRST_INACTIVE_WITH_PURGE', 'SDTAudio',
    'SLTUser', 'DISPID_SRGetRecognizers', 'SVEWordBoundary',
    'SRAInterpreter', 'SAFTCCITT_uLaw_11kHzStereo', 'SASClosed',
    'DISPID_SGRsCommitAndSave', 'SPLEXICONTYPE', 'SGDSActive',
    ...
    'DISPID_SPRuleChildren', 'SAFT16kHz16BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpInProcRecoContext',
    'SPFM_CREATE', 'DISPID_SRCState', 'SAFT44kHz8BitStereo',
    'SpeechWordPronounceable', 'SpeechSpecialTransitionType',
    'SP_VISEME_21', 'DISPID_SPRuleName', 'eLEXTYPE_RESERVED10',
    'SpeechMicTraining', 'DISPID_SpeechObjectTokens',
    'SPSERIALIZEDPHRASE', 'SVP_12', 'SPPS_Modifier', 'SPEI_MAX_TTS',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFTGSM610_8kHzMono',
    'ISpeechRecoResultDispatch', 'SPVPRI_OVER', 'SPRS_INACTIVE',
    'STSF_LocalAppData', 'DISPID_SRCERequestUI', 'SECHighConfidence',
    'DISPID_SOTDataKey', 'ISpGrammarBuilder', 'SPEI_RESERVED1',
    'SREAdaptation', 'DISPID_SRRAudioFormat', 'SpMMAudioEnum',
    'SVEStartInputStream', 'eLEXTYPE_PRIVATE18',
    'SPEI_START_INPUT_STREAM', 'DISPID_SLWWord', 'SVF_Emphasis',
    'DISPID_SRCRequestedUIType',
    'SpeechPropertyLowConfidenceThreshold', 'SPSFunction',
    'SpeechRecognitionType', 'SPPS_RESERVED1',
    'DISPID_SVSCurrentStreamNumber', 'STCInprocHandler',
    'SpeechTokenIdUserLexicon', 'SDTAll', 'DISPID_SPPName',
    'SRTStandard', 'ISpeechPhraseProperties', 'SpMemoryStream',
    'SPLO_STATIC', 'SVSFParseSsml', 'SPSHT_OTHER',
    'eLEXTYPE_PRIVATE1', 'SAFT24kHz16BitStereo',
    'DISPID_SPRDisplayAttributes', 'SGPronounciation',
    'DISPID_SRCEEndStream', 'SAFTADPCM_22kHzStereo', 'SREAudioLevel',
    'SPWAVEFORMATTYPE', 'SAFTExtendedAudioFormat', 'DISPID_SASState',
    'SPPS_RESERVED2', 'eLEXTYPE_MORPHOLOGY', 'SpeechRecoContextState',
    'SAFT8kHz8BitMono', 'SVEPhoneme', 'DISPID_SVESentenceBoundary',
    'SP_VISEME_10', 'SpSharedRecoContext', 'DISPID_SLWType',
    'DISPID_SpeechRecoContextEvents', 'SPWORDLIST',
    'SAFTADPCM_11kHzStereo', 'DISPID_SDKGetStringValue',
    'SPXMLRESULTOPTIONS', 'SPCT_COMMAND', 'DISPID_SABufferNotifySize',
    'SPEI_SOUND_START', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SDKDeleteValue', 'SVEPrivate', 'DISPID_SOTGetDescription',
    'ISpDataKey', 'SPRST_INACTIVE', 'DISPID_SRRTTickCount',
    'SVEViseme', 'DISPID_SOTsItem', 'SAFT12kHz8BitMono', 'ISpLexicon',
    'ISpObjectWithToken', 'DISPID_SLPsItem', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseProperties', 'SVSFParseMask',
    ...
    'SpeechLexiconType', 'DISPID_SOTCDefault', 'eLEXTYPE_RESERVED9',
    'SpeechRetainedAudioOptions',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPDKL_CurrentConfig',
    'DISPID_SRRTimes', 'SpMMAudioOut', 'STSF_AppData',
    ...
    'SPGRAMMARSTATE', 'DISPID_SpeechAudioStatus', 'SPPARTOFSPEECH',
    'SGDSActiveUserDelimited', 'SPAUDIOSTATE',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCEStartStream',
    'SRSInactive', 'SPVPRI_ALERT', 'SPFM_CREATE_ALWAYS',
    'SVF_Stressed', 'SDKLDefaultLocation', 'SRSActive',
    'DISPID_SpeechPhraseRules',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SBSFormat',
    'SpeechEmulationCompareFlags', 'SITooSlow',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRGState', 'SPPS_Noun',
    'SWPUnknownWordUnpronounceable', 'SpeechRuleState',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPIAudioSizeTime',
    'SREInterference', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRsItem',
    'DISPID_SRCERecognitionForOtherContext', 'SPRST_ACTIVE',
    'DISPID_SRRAlternates', 'SPFILEMODE', 'DISPID_SVAudioOutput',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPERequiredConfidence',
    'SPWF_SRENGINE', 'DISPID_SPEDisplayAttributes', 'SRAONone',
