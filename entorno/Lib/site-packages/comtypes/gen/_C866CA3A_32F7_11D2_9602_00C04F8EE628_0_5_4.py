...
__all__ = [
    'SDTReplacement', 'DISPID_SWFEExtraData', 'DISPID_SAEventHandle',
    'SDKLLocalMachine', 'SpeechInterference', 'SRTAutopause',
    'SpeechCategoryAudioIn',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTADPCM_11kHzStereo', 'DISPID_SpeechRecoResultTimes',
    'SBONone', 'DISPID_SASNonBlockingIO', 'SLTUser',
    'DISPID_SpeechDataKey', 'SREPrivate', 'DISPID_SRGState',
    'SDA_No_Trailing_Space', 'SITooLoud', 'DISPID_SpeechObjectToken',
    'DISPID_SLWPronunciations', 'SPWT_DISPLAY',
    'tagSPTEXTSELECTIONINFO', 'SpeechEmulationCompareFlags',
    'SPPS_RESERVED3', 'SPSHORTCUTPAIR', 'SP_VISEME_5',
    'DISPID_SPACommit', 'DISPID_SpeechPhraseInfo',
    'eLEXTYPE_PRIVATE14', 'SpMMAudioOut', 'SVEEndInputStream',
    'SpPhraseInfoBuilder', 'SVSFParseMask', 'DISPID_SRDisplayUI',
    'SLTApp', 'SpeechLexiconType', 'SAFT44kHz16BitStereo',
    'DISPID_SRCERecognition', 'SAFTGSM610_22kHzMono',
    'DISPID_SASetState', 'DISPID_SpeechAudioStatus', 'SPAO_NONE',
    'SAFT12kHz16BitMono', 'ISpStreamFormat', 'ISpeechVoiceStatus',
    'DISPID_SVIsUISupported', 'DISPID_SVSInputWordPosition',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechMemoryStream',
    'DISPID_SPIProperties', 'DISPID_SVResume',
    'SpTextSelectionInformation', 'SPSSuppressWord', 'SP_VISEME_21',
    ...
    'SpeechLoadOption', '__MIDL_IWinTypes_0009', 'SpStream',
    'SGRSTTDictation', 'SP_VISEME_1',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRSetPropertyString', 'DISPID_SASCurrentDevicePosition',
    'SPSFunction', 'SPEI_TTS_PRIVATE', 'SPSLMA',
    'DISPID_SRRTOffsetFromStart', 'ISpObjectTokenCategory',
    'DISPID_SRGIsPronounceable', 'ISpeechRecoContext',
    'DISPID_SRGReset', 'SpInprocRecognizer', 'SpNullPhoneConverter',
    'SINone', 'SSTTWildcard', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechLexiconProns', 'SREStreamEnd',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SDA_Consume_Leading_Spaces',
    'SDTProperty', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCEPhraseStart',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPEAudioSizeBytes',
    'SPGS_EXCLUSIVE', 'ISpRecoContext2',
    'ISpeechGrammarRuleStateTransition', 'SPRST_ACTIVE',
    'SP_VISEME_8', 'SREHypothesis', 'SAFT12kHz16BitStereo',
    'SPEI_SOUND_START', 'ISpNotifySink',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPIRule',
    'SPPS_NotOverriden', 'IEnumSpObjectTokens', 'SAFT44kHz8BitMono',
    'SAFTADPCM_44kHzStereo', 'SPRECOGNIZERSTATUS', 'DISPID_SGRsItem',
    'DISPID_SABIEventBias', 'SPINTERFERENCE_TOOFAST',
    'SPCT_SUB_DICTATION', 'SpeechEngineConfidence',
    'SpeechTokenContext', 'SAFT22kHz8BitMono', 'DISPID_SGRSRule',
    'SREPropertyNumChange', 'SPLEXICONTYPE', 'DISPID_SRStatus',
    'SVEPhoneme', 'DISPID_SLPsCount', 'DISPID_SPRuleEngineConfidence',
    'SAFT8kHz8BitMono', 'SPEI_PHRASE_START', 'SpeechRecoEvents',
    'SVSFDefault', 'SPAO_RETAIN_AUDIO', 'ISpRecoCategory',
    'SPEI_REQUEST_UI', 'SpMMAudioEnum', 'DISPID_SLPPhoneIds',
    'SPSNoun', 'DISPID_SVSInputSentenceLength', 'SpFileStream',
    'ISpDataKey', 'SAFTNonStandardFormat', 'DISPID_SAFType',
    'DISPID_SRIsUISupported', 'DISPID_SRRPhraseInfo',
    'SpMemoryStream', 'SAFT48kHz16BitMono', 'SAFT44kHz16BitMono',
    'eLEXTYPE_PRIVATE2', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSLastResult', 'DISPID_SLWsItem', 'SGRSTTTextBuffer',
    'SAFT32kHz16BitMono', 'SP_VISEME_6',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechLexiconWords',
    'SINoSignal', 'SECLowConfidence', 'ISpeechPhraseAlternate',
    ...
    'SRAImport', 'ISpeechRecoResultTimes', 'SRSActiveAlways', 'SVP_6',
    '_ISpeechVoiceEvents', 'DISPID_SVSRunningState',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechObjectToken', 'SVSFIsFilename',
    'DISPID_SRGRules', 'SPWT_LEXICAL', 'SP_VISEME_18', 'SECFDefault',
    'DISPID_SRRSetTextFeedback', 'SAFT32kHz16BitStereo', 'SBOPause',
    'eLEXTYPE_PRIVATE8', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRGCmdLoadFromMemory', 'eWORDTYPE_DELETED',
    'SPVPRI_NORMAL', 'DISPID_SWFEBlockAlign', 'SP_VISEME_9',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVP_17', 'DISPID_SOTRemove',
    'SAFT16kHz16BitStereo', 'DISPID_SDKCreateKey',
    'SPEI_RECO_STATE_CHANGE', 'SGSDisabled',
    'SPINTERFERENCE_NOSIGNAL', 'SGDSActiveWithAutoPause', 'SASClosed',
    'SDTLexicalForm', 'SPEI_END_INPUT_STREAM', 'DISPID_SFSClose',
    'SP_VISEME_12', 'DISPID_SLWType',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SOTGetDescription',
    'ISpeechAudio', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechXMLRecoResult',
    'SpShortcut', 'Speech_Default_Weight', 'SPVPRI_OVER',
    'DISPID_SLPsItem', 'SPCONTEXTSTATE', 'SAFT16kHz16BitMono',
    'SSFMCreate', 'SPDKL_CurrentConfig', 'DISPID_SWFESamplesPerSec',
    'SVP_13', 'SPSMF_UPS', 'DISPID_SPRulesItem',
    'DISPID_SABufferNotifySize', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SBSWrite',
    'SpeechDictationTopicSpelling', 'SP_VISEME_14', 'SP_VISEME_17',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechRecognizer',
    'DISPID_SRCERecognitionForOtherContext', 'ISpeechPhraseElement',
    'DISPID_SPRuleFirstElement', 'SpAudioFormat', 'ISpRecognizer2',
    'SREStateChange', 'SVESentenceBoundary', 'SRESoundEnd',
    'SPEVENTSOURCEINFO', 'SVSFParseSapi', 'DISPID_SLWs_NewEnum',
    'DISPID_SGRAddState', 'SPINTERFERENCE_NOISE', 'DISPID_SRRTLength',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSpeakStream',
    'SpeechAudioFormatGUIDWave', 'STCAll', 'DISPIDSPTSI',
    'SPEI_PHONEME', 'SPPROPERTYINFO', 'DISPID_SGRSTsItem',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechPhraseProperties', 'SASRun',
    'SPEI_END_SR_STREAM', 'SPRULESTATE', 'DISPID_SRCState',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVVoice',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechXMLRecoResult', 'SDTAll',
    'DISPID_SPRsCount', 'SpeechGrammarRuleStateTransitionType',
    'ISpStreamFormatConverter', 'DISPID_SPIEngineId', 'DISPID_SVRate',
    'DISPID_SPRDisplayAttributes', 'SpeechVoicePriority',
    'SGDSInactive', 'DISPID_SpeechRecoContext',
    'SAFTNoAssignedFormat', 'SPDKL_DefaultLocation',
    'DISPID_SPIStartTime', 'DISPID_SPIReplacements', 'ISpPhrase',
    'DISPID_SVEWord', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVGetVoices', 'SITooSlow', 'SSTTDictation',
    'SPSTREAMFORMATTYPE', 'SPPS_RESERVED4', 'SRSActive',
    'SPSERIALIZEDPHRASE', 'SVP_20', 'DISPIDSPTSI_ActiveOffset',
    'SpNotifyTranslator', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT8kHz8BitStereo', 'SpeechCategoryVoices', 'ISpXMLRecoResult',
    'DISPID_SWFEFormatTag', 'SRTStandard', 'DISPID_SGRSTWeight',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_16',
    'SpSharedRecognizer', 'SFTInput', 'DISPID_SVSCurrentStreamNumber',
    'SpeechCategoryPhoneConverters', 'DISPID_SVAudioOutput',
    'DISPID_SRCRecognizer', 'ISpeechGrammarRule', 'ISpStream',
    'DISPID_SRGRecoContext', 'SPPS_Unknown', 'DISPID_SPRs_NewEnum',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSTNextState', 'SVF_None',
    'SAFT22kHz16BitStereo', 'ISpeechRecoResult',
    'DISPID_SOTIsUISupported', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRSTPropertyId',
    'SPLO_STATIC', 'SPPS_RESERVED1', 'ISpGrammarBuilder',
    'DISPID_SOTCategory', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechAudioFormat', 'DISPID_SPELexicalForm',
    'SGRSTTEpsilon', 'SPEI_WORD_BOUNDARY', 'eLEXTYPE_APP',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCEInterference', 'SAFT48kHz8BitMono', 'SVP_1',
    'SAFT24kHz16BitMono', 'SPEI_MAX_SR', 'DISPID_SMSAMMHandle',
    'SVSFPurgeBeforeSpeak', 'DISPID_SBSFormat', 'SP_VISEME_7',
    'DISPID_SRCEventInterests', 'SPSHT_EMAIL',
    'IInternetSecurityManager', 'eLEXTYPE_PRIVATE5',
    'SAFTADPCM_11kHzMono', 'DISPID_SOTCGetDataKey', 'SREPhraseStart',
    'DISPID_SGRsCommitAndSave', 'ISequentialStream', 'SPRST_INACTIVE',
    'ISpeechPhraseInfo', 'STCInprocServer', 'DISPID_SRState',
    'DISPID_SVDisplayUI', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechPhraseProperties', 'SGDSActiveUserDelimited',
    'DISPID_SRRTimes', 'SPPS_Modifier', 'SpeechGrammarWordType',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SBSSeek',
    'SpeechCategoryRecoProfiles', 'SVP_0', 'DISPID_SDKGetBinaryValue',
    'SVSFlagsAsync', 'SPEI_UNDEFINED', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SGRAttributes', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPCT_DICTATION', 'SPGS_DISABLED', 'SAFT48kHz8BitStereo',
    'SPWORDTYPE', 'SDKLDefaultLocation', 'SpeechRecoContextState',
    'DISPID_SPIGrammarId', 'DISPID_SPIGetDisplayAttributes',
    'SpeechVoiceCategoryTTSRate', 'SREBookmark', 'SPRECORESULTTIMES',
    'ISpeechPhraseAlternates', 'SREAdaptation', 'SpeechMicTraining',
    'DISPID_SpeechGrammarRuleState', 'eLEXTYPE_PRIVATE3', 'SVSFIsXML',
    'SITooQuiet', 'SAFT12kHz8BitMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRATopLevel', 'SpPhoneticAlphabetConverter', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPRuleName', 'SPINTERFERENCE_TOOLOUD',
    'SAFT32kHz8BitStereo', 'SVSFParseAutodetect', 'SPEI_SOUND_END',
    'DISPID_SRGCommit', 'DISPID_SRSCurrentStreamNumber',
    'SPVPRIORITY', 'SPAS_PAUSE', 'DISPID_SRAudioInput', 'SP_VISEME_0',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_START_SR_STREAM',
    'DISPID_SGRAddResource', 'SPSModifier', 'SpWaveFormatEx',
    'DISPID_SLPSymbolic', 'SDTPronunciation', 'DISPID_SPEs_NewEnum',
    'DISPID_SPEAudioSizeTime', 'ISpeechPhraseReplacement',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechLexiconPronunciations', 'SPFM_CREATE', 'SPRECOSTATE',
    'SPEI_FALSE_RECOGNITION', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE9', 'SPSHORTCUTTYPE', 'SPVISEMES',
    'DISPID_SPPName', 'SPXRO_SML', 'SpeechRecoProfileProperties',
    'SPFM_OPEN_READONLY', 'DISPID_SOTId', 'SSTTTextBuffer',
    'SPSHORTCUTPAIRLIST', 'SPPS_RESERVED2', 'SDA_Two_Trailing_Spaces',
    ...
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCResume', 'ISpShortcut', 'SPSHT_Unknown',
    'DISPID_SpeechVoice', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SOTCSetId', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SECFIgnoreCase', 'DISPID_SGRSAddWordTransition',
    'DISPID_SOTsCount', 'DISPID_SRCESoundStart', 'ISpRecoContext',
    'ISpSerializeState', 'SAFT11kHz8BitStereo',
    'DISPID_SRRSaveToMemory', 'SGLexical', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPPValue', 'DISPID_SWFEAvgBytesPerSec',
    'SRERecoOtherContext', 'SPAS_RUN', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_RECOGNITION',
    'ISpeechPhraseRule', 'DISPID_SVVolume', 'ISpRecognizer3',
    'SDTDisplayText', 'SpeechGrammarState', 'SAFT24kHz16BitStereo',
    'DISPID_SPRules_NewEnum', 'SPPHRASE', 'SRSInactive',
    'SGPronounciation', 'ISpeechCustomStream', 'WAVEFORMATEX',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_MORPHOLOGY',
    'SPSInterjection', 'DISPID_SPPBRestorePhraseFromMemory',
    'SRAExport', 'DISPID_SVStatus', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRGDictationUnload', 'ISpeechPhoneConverter',
    'SPAUDIOSTATUS', 'DISPID_SPEAudioStreamOffset', 'SPFILEMODE',
    'STCInprocHandler', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SCSBaseStream', 'SREInterference', 'SRCS_Enabled',
    'SPINTERFERENCE_NONE', 'DISPID_SPRFirstElement',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT8kHz16BitStereo',
    'SPEVENTENUM', 'ISpRecoResult', 'SVEAudioLevel', 'SPEI_RESERVED1',
    'SpMMAudioIn', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPISaveToMemory', 'SPEI_MIN_SR', 'SPWORDPRONUNCIATION',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SOTCreateInstance', 'SpeechBookmarkOptions',
    'STCLocalServer', 'DISPID_SVSLastBookmark', 'SVP_18',
    'SPAS_CLOSED', 'SRARoot', 'DISPID_SPAsCount', 'SPGRAMMARSTATE',
    'ISpeechLexiconWords', 'DISPID_SPRuleConfidence',
    'DISPID_SRRRecoContext', 'SDKLCurrentUser',
    'DISPID_SABIMinNotification', 'eLEXTYPE_PRIVATE7',
    'SPXMLRESULTOPTIONS', 'DISPID_SBSRead', 'DISPID_SLPType',
    'SVF_Emphasis', 'DISPID_SAFGuid',
    'DISPID_SRCEPropertyStringChange', 'Speech_Max_Pron_Length',
    'SPRULE', 'SRAONone', 'DISPID_SGRSTType', 'ISpeechBaseStream',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCPause', 'SVP_19', 'SVP_11',
    'SGRSTTWord', 'DISPID_SMSALineId', 'SPEI_VOICE_CHANGE',
    ...
    'DISPID_SOTDisplayUI', 'SpeechTokenKeyUI', 'tagSTATSTG',
    'SpeechAudioState', 'SP_VISEME_2', 'DISPIDSPTSI_ActiveLength',
    'SpeechCategoryRecognizers', 'SpeechFormatType', 'SPINTERFERENCE',
    'SFTSREngine', 'ISpeechAudioFormat', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechMMSysAudio', 'SpResourceManager',
    'SPDKL_LocalMachine', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE19',
    'SVPNormal', 'SpStreamFormatConverter', 'eWORDTYPE_ADDED',
    'DISPID_SGRClear', 'DISPID_SRRSpeakAudio', 'ISpEventSource',
    'DISPID_SVEPhoneme', 'SpeechAudioFormatGUIDText', 'DISPID_SOTCId',
    'SPCT_SUB_COMMAND', 'SPSERIALIZEDRESULT',
    'DISPID_SLGetPronunciations', 'SWTDeleted', 'SPAR_Unknown',
    'tagSPPROPERTYINFO', 'SPAUDIOOPTIONS', 'SVEViseme',
    'DISPID_SABufferInfo', 'DISPID_SGRs_NewEnum', 'SRSEDone',
    ...
    'DISPID_SPEDisplayText', 'DISPID_SPRText', 'SSFMOpenForRead',
    'SPAS_STOP', 'SAFTCCITT_ALaw_44kHzMono', 'SVF_Stressed',
    'SGRSTTRule', 'DISPID_SVEViseme', 'DISPID_SRGetFormat',
    'SP_VISEME_20', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SREmulateRecognition', 'DISPID_SPPEngineConfidence',
    'SSFMOpenReadWrite', 'eLEXTYPE_USER', 'SPVOICESTATUS', 'SVP_7',
    'ISpeechRecognizer', 'DISPID_SRCRequestedUIType', 'SPSHT_OTHER',
    'SECFEmulateResult', 'DISPID_SPIAudioStreamPosition',
    'SpeechUserTraining', 'DISPID_SGRsCommit', 'DISPID_SPPConfidence',
    'ISpObjectWithToken', 'SVEPrivate', 'DISPID_SOTsItem',
    'SPPS_Noncontent', 'DISPID_SVAlertBoundary',
    '_ISpeechRecoContextEvents', 'SPEI_SR_PRIVATE',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_PRIVATE15',
    'SWPUnknownWordPronounceable', 'SVPAlert', 'SLODynamic',
    'SDA_One_Trailing_Space', 'ISpeechLexiconPronunciation',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechVoiceStatus',
    'SSSPTRelativeToEnd', 'SVP_8', 'SREFalseRecognition',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechRecoResult',
    'SPEI_INTERFERENCE', 'SPDKL_CurrentUser', 'SVSFUnusedFlags',
    'DISPID_SRCEAdaptation', 'SVEBookmark', 'eLEXTYPE_PRIVATE11',
    'SVP_10', 'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechCustomStream',
    'DISPID_SOTCEnumerateTokens', 'SPPS_Noun', 'SPEI_HYPOTHESIS',
    'DISPID_SLRemovePronunciation', 'DISPID_SLGetGenerationChange',
    'DISPID_SRGDictationLoad', 'DISPID_SGRsCount', 'DISPID_SGRSTRule',
    'DISPID_SPANumberOfElementsInResult', 'SPLOADOPTIONS',
    'SPFM_CREATE_ALWAYS', 'Speech_StreamPos_Asap', 'SVSFIsNotXML',
    'DISPID_SAVolume', 'eLEXTYPE_LETTERTOSOUND', 'SP_VISEME_15',
    'DISPID_SPRulesCount', 'IInternetSecurityMgrSite',
    'DISPID_SPAPhraseInfo', 'DISPID_SOTRemoveStorageFileName',
    'SPWF_INPUT', 'DISPID_SGRId', 'DISPID_SPEsCount', 'ISpPhraseAlt',
    'Speech_StreamPos_RealTime', 'SPSEMANTICFORMAT',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechGrammarRule',
    'SpeechWordPronounceable', 'SPFM_OPEN_READWRITE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPBINARYGRAMMAR',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRRAlternates', 'DISPID_SOTGetAttribute',
    'ISpeechRecoGrammar', 'SPPS_Interjection', 'ISpRecoGrammar',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SAStatus',
    'SpeechStreamFileMode', 'SPSVerb', 'SP_VISEME_19',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SVPriority',
    'DISPID_SDKOpenKey', 'SPADAPTATIONRELEVANCE',
    'SAFT12kHz8BitStereo', 'SPEI_ADAPTATION', 'ISpProperties',
    'SPRS_ACTIVE', 'eLEXTYPE_PRIVATE10', 'SpeechGrammarTagWildcard',
    'SRSEIsSpeaking', 'SRTExtendableParse', 'SPDATAKEYLOCATION',
    'DISPID_SPCIdToPhone', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCEEndStream', 'DISPID_SPAsItem', 'SPAUDIOBUFFERINFO',
    'SpeechAudioProperties', 'SPGRAMMARWORDTYPE', 'SINoise',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_MAX_TTS',
    'SECNormalConfidence', 'SLOStatic', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRGetRecognizers', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPCPhoneToId', 'SPWORDPRONOUNCEABLE', 'SPAR_Medium',
    'SpeechPartOfSpeech', 'SPBO_TIME_UNITS', 'DISPID_SPILanguageId',
    'SAFT16kHz8BitMono', 'DISPID_SVEVoiceChange', 'ISpeechMMSysAudio',
    'SpeechCategoryAudioOut', 'SpeechPropertyResponseSpeed', 'SVP_12',
    ...
    'DISPID_SPERetainedStreamOffset', 'SPPS_Verb', 'SASPause',
    'SPSNotOverriden', 'SECFIgnoreKanaType', 'DISPID_SVEStreamEnd',
    'DISPID_SDKDeleteKey', 'IStream', 'SPFM_NUM_MODES',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPPsItem', 'SAFT32kHz8BitMono', 'ISpNotifyTranslator',
    'DISPID_SRCESoundEnd', 'SAFT11kHz16BitMono', 'SVSFParseSsml',
    'SpCompressedLexicon', 'DISPID_SpeechAudio', 'ISpPhoneConverter',
    'SpSharedRecoContext', 'DISPID_SPEEngineConfidence',
    'ISpeechVoice', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SRERequestUI', 'SECHighConfidence', 'SpInProcRecoContext',
    'ISpeechAudioStatus', 'SVP_2', 'ISpObjectToken',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpPhoneConverter',
    'DISPID_SPPChildren', 'STSF_CommonAppData', 'eLEXTYPE_RESERVED9',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPRuleId', 'DISPID_SPRuleChildren', 'SRTReSent',
    'DISPID_SDKEnumValues', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVEBookmark', 'SAFTADPCM_44kHzMono',
    'SPEI_START_INPUT_STREAM', 'SWPUnknownWordUnpronounceable',
    'SVSFVoiceMask', 'ISpeechDataKey', 'DISPID_SVSpeakCompleteEvent',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SDKGetStringValue',
    'SREStreamStart', 'DISPID_SRCCreateResultFromMemory',
    'SPPARTOFSPEECH', 'DISPID_SADefaultFormat', 'SPCT_COMMAND',
    'SPLO_DYNAMIC', 'DISPID_SDKSetStringValue', 'SVP_14',
    'SpeechRunState', 'DISPID_SRRGetXMLResult',
    'SpeechAudioFormatType', 'ISpPhoneticAlphabetConverter',
    'SPPHRASERULE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpRecognizer', 'DISPID_SGRsFindRule', 'DISPID_SPEsItem',
    'SPEI_RESERVED2', 'ISpLexicon', 'ISpeechPhraseProperty',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPS_SuppressWord',
    'DISPID_SpeechAudioBufferInfo', 'SPPHRASEPROPERTY',
    'DISPID_SRCEEnginePrivate', 'SPBO_NONE', 'DISPID_SABIBufferSize',
    'SAFT24kHz8BitMono', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRNumberOfElements', 'SRESoundStart',
    'DISPID_SRRDiscardResultInfo', 'SpLexicon', 'SDTRule',
    'SpObjectToken', 'ISpPhoneticAlphabetSelection', 'SPBO_AHEAD',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRInitialState',
    'DISPID_SRCEHypothesis', 'DISPID_SPIGetText',
    'DISPID_SPEActualConfidence', 'DISPID_SPRsItem',
    'DISPID_SDKGetlongValue', 'DISPID_SRGetPropertyString',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpCustomStream', 'SVP_15',
    'SpeechVisemeType', 'SPEVENT', 'DISPID_SLPs_NewEnum',
    'DISPID_SRSAudioStatus', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SpeechBaseStream', 'DISPID_SRGId',
    'SpeechRegistryUserRoot', 'SAFT24kHz8BitStereo',
    'DISPID_SVSVisemeId', 'SPRST_NUM_STATES',
    'DISPID_SVESentenceBoundary', 'SWTAdded', 'SPAR_High',
    'DISPID_SGRSTPropertyValue', '_RemotableHandle',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRuleParent',
    'SpeechRecognizerState', 'DISPID_SpeechPhraseElements',
    'SVEAllEvents', 'DISPID_SASState', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTGSM610_8kHzMono',
    'STSF_LocalAppData', 'SRERecognition', 'SVP_4',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRRAudioFormat',
    'DISPID_SGRName', 'DISPID_SRRecognizer', 'SECFNoSpecialChars',
    'SAFTGSM610_11kHzMono', 'DISPID_SWFEChannels',
    'DISPID_SPEPronunciation', 'SREAllEvents', 'SpeechDiscardType',
    'SREPropertyStringChange', 'SVP_3', 'DISPID_SDKSetBinaryValue',
    'SGLexicalNoSpecialChars', 'SPRST_INACTIVE_WITH_PURGE',
    'SPPS_LMA', 'SVP_5', 'SVEWordBoundary', 'SpeechAllElements',
    'DISPID_SVGetAudioOutputs',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVSFNLPSpeakPunc',
    'DISPID_SRCEBookmark', 'SP_VISEME_4', 'SpeechRuleAttributes',
    'DISPID_SOTSetId', 'DISPID_SVSLastBookmarkId', 'SAFTText',
    'SpeechRuleState', 'DISPID_SpeechPhraseRules',
    'DISPID_SPERetainedSizeBytes', 'SASStop', 'DISPID_SRProfile',
    'SPWT_PRONUNCIATION', 'SpeechDisplayAttributes',
    'SRAORetainAudio', 'SPBOOKMARKOPTIONS',
    'DISPID_SRGetPropertyNumber', 'DISPIDSPTSI_SelectionOffset',
    'ISpVoice', 'DISPID_SRCreateRecoContext', 'ISpMMSysAudio',
    'SREAudioLevel', 'SPCATEGORYTYPE', 'DISPID_SPPNumberOfElements',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechRecoResult2',
    'DISPID_SLPPartOfSpeech', 'DISPID_SLWWord', 'SPVPRI_ALERT',
    'SVEVoiceChange', 'DISPID_SVGetProfiles', 'SECFIgnoreWidth',
    'ISpeechResourceLoader', 'DISPID_SPPId', 'SVSFNLPMask',
    'DISPID_SPPParent', 'Speech_Max_Word_Length',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRIsShared',
    'SPTEXTSELECTIONINFO', 'SRCS_Disabled', 'SP_VISEME_11',
    'SPPHRASEREPLACEMENT', 'DISPID_SpeechPhraseProperty',
    ...
    'SAFT22kHz16BitMono', 'DISPID_SVSPhonemeId', 'DISPID_SGRsAdd',
    'SAFT11kHz16BitStereo', 'SGDisplay', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCCreateGrammar', 'SPPHRASEELEMENT',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SOTCDefault',
    'DISPID_SRSNumberOfActiveRules', 'SpeechVisemeFeature',
    'DISPID_SGRSTText', 'SAFT48kHz16BitStereo', 'SPPS_Function',
    'ISpeechFileStream', 'eLEXTYPE_RESERVED8', 'SPSHT_NotOverriden',
    'SPEI_VISEME', 'SpeechWordType', 'SpeechAddRemoveWord',
    'SPWAVEFORMATTYPE', 'SPEI_SR_BOOKMARK',
    ...
    'DISPID_SRCRetainedAudio', 'SPBO_PAUSE', 'SPSUnknown',
    'ISpeechGrammarRules', 'DISPID_SRRAudio', 'SAFT8kHz16BitMono',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechLexicon',
    'DISPID_SRRTTickCount', 'DISPID_SPEDisplayAttributes',
    'SPRS_ACTIVE_USER_DELIMITED', 'STSF_FlagCreate',
    'ISpeechLexiconWord', 'SpVoice', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechVoiceEvents', 'SAFTExtendedAudioFormat',
    'DISPID_SDKSetLongValue', 'eLEXTYPE_RESERVED7', 'DISPID_SRCVoice',
    'DISPID_SVSkip', 'SVPOver', 'eLEXTYPE_PRIVATE12',
    'ISpeechPhraseElements', 'SDKLCurrentConfig', 'SRAInterpreter',
    'SGRSTTWildcard', 'DISPID_SVSLastStreamNumberQueued',
    'SP_VISEME_3', 'SPWORDLIST', 'SP_VISEME_13', 'DISPID_SGRsDynamic',
    'SRADynamic', 'SAFTCCITT_uLaw_8kHzMono',
    ...
    'SPXRO_Alternates_SML', 'SRTEmulated', 'DISPID_SRCEStartStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRSClsidEngine',
    'ISpeechRecognizerStatus', 'SAFT11kHz8BitMono', 'SVP_9', 'SVP_16',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVWaitUntilDone',
    'SP_VISEME_10', 'DISPID_SLWsCount', '_SPAUDIOSTATE',
    'SWPKnownWordPronounceable', 'DISPID_SMSADeviceId',
    'SpeechPropertyAdaptationOn', 'ISpeechWaveFormatEx',
    'DISPID_SRCBookmark', 'DISPID_SPAStartElementInResult',
    'SGSEnabled', 'eLEXTYPE_PRIVATE17', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechSpecialTransitionType', 'STCRemoteServer', 'SPAR_Low',
    'SPWF_SRENGINE', 'SPEI_SR_AUDIO_LEVEL', 'ISpeechLexicon',
    'DISPID_SASFreeBufferSpace', 'SPEI_MIN_TTS', 'SVP_21',
    'SITooFast', 'ISpNotifySource', 'DISPID_SLGenerationId',
    'DISPID_SPPsCount', 'DISPID_SRCEPropertyNumberChange',
    'SpeechDataKeyLocation', 'DISPID_SPIElements',
    'DISPID_SPRuleNumberOfElements', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPPFirstElement', 'SpeechTokenKeyFiles', 'SPCS_ENABLED',
    'DISPID_SMSSetData', 'SpeechTokenIdUserLexicon',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCVoicePurgeEvent',
    'eLEXTYPE_PRIVATE4', 'DISPID_SFSOpen', 'SPAUDIOSTATE',
    'DISPID_SDKDeleteValue', 'eLEXTYPE_RESERVED10',
    'DISPID_SPCLangId', 'SGDSActive', 'DISPID_SOTs_NewEnum',
    'SRTSMLTimeout', 'DISPID_SGRSTPropertyName', 'IEnumString',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechLexiconWord',
    'SVSFPersistXML', 'DISPID_SOTMatchesAttributes', 'SAFTDefault',
    'DISPID_SpeechObjectTokens', 'SPRS_INACTIVE', 'DISPID_SLWLangId',
    'DISPID_SOTDataKey', 'SPEI_RESERVED5', 'LONG_PTR',
    'DISPID_SLAddPronunciation', 'SpUnCompressedLexicon',
    'DISPIDSPRG', 'SPCS_DISABLED', 'ISpeechRecoResultDispatch',
    'eLEXTYPE_RESERVED6', 'STSF_AppData', 'ISpEventSink', 'UINT_PTR',
    'SpeechEngineProperties', 'SPWORD', 'SpeechGrammarTagDictation',
    'DISPID_SRCEAudioLevel', 'SPCT_SLEEP', 'DISPID_SVEventInterests',
    'ISpAudio', 'DISPID_SPPs_NewEnum', 'DISPID_SVAudioOutputStream',
    'ISpeechPhraseRules', 'SPGS_ENABLED', 'DISPID_SVEStreamStart',
    'ISpeechMemoryStream', 'DISPID_SVSpeak', 'SpeechRecognitionType',
    'DISPID_SVEEnginePrivate', 'SGSExclusive', 'ISpeechObjectTokens'
]

_check_version('1.2.0', 1617976599.607034)
